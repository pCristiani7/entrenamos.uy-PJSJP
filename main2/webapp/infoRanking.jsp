...
<body>
	...
	<%
		...
		if (mostrar.equals("actividades")) {
			DtActividadDeportiva[] actividades = (DtActividadDeportiva[]) request.getAttribute("dtacts");
	%>
	<h1>
	...
	<%
			...
			DtClase[] dtc = (DtClase[]) request.getAttribute("dtclases");
	%>
	<h1>
		Clases
		</h1>
			...
			<%
				int i = 1;
					for (DtClase dtClase : dtc) {
						String fecha = new SimpleDateFormat ("dd-MM-yyyy").format(dtClase.getFecha().getTime());
			%>
			<tr>
				<th scope="row"><%=i%></th>
