...
public class AltaInstitucionDeportiva extends JInternalFrame {
	...
	protected void altaInstitucionDeportivaAceptarPerformed(ActionEvent arg0) {
		...
		if(checkFormulario()) {
			try {
				...
				JOptionPane.showMessageDialog(this, "Institucion agregada con �xito!", "Alta Institucion Deportiva",
	...
	private boolean checkFormulario() {
        ...
        if (nombre.isEmpty() || desc.isEmpty() || url.isEmpty()) {
            JOptionPane.showMessageDialog(this, "No puede haber campos vac�os", "Alta Institucion Deportiva",
