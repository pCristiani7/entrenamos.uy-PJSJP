...
<%
        ...
        DtProfesor dtProf = icon.findProfesor(nicknamee);
        String imgEnn = (String)Base64.getEncoder().encodeToString(dtProf.getProfileImage());
 %>
			...
			<div class="container">
				<div class="card">
					...
					<div class="inputBox">
					    ...
					    <script>document.getElementById('3').value='<%=dtProf.getFechaNac()%>';</script>
					  </div>
					 <div class="inputBox">
