...
public class ModificarActividadDeportiva extends JInternalFrame {
	...
	protected void modificarActividadActionPerformed(ActionEvent arg0) {
		...
		DtActividadDeportiva dtActNew = new DtActividadDeportiva(dtActOld.getNombre(),desc,duracion,costo,dtActOld.getFecha(),dtActOld.getInstitucionDeportiva());
		
		if(iCon.ModificarActividadDeportiva(dtActOld.getNombre(),dtActNew)) {
			JOptionPane.showMessageDialog(this, "Actividad modificada con �xito!", "Modificar Actividad",
