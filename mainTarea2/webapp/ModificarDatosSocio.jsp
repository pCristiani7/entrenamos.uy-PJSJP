			...
			<div class="container">
				<div class="card">
					...
					<div class="inputBox">
						...
						<script>document.getElementById('1').value='<%=dtSocio.getNombre()%>';</script>
						<span>Nombre del Socio</span>
					</div>
					<div class="inputBox">
						<input id="2" type="text" name="apeUsuario">
						<script>document.getElementById('2').value='<%=dtSocio.getApellido()%>';</script>
						<span>Apellido del Socio</span>
					</div>
					<div class="inputBox">
					    <label>Fecha de Nacimiento nueva</label>
					    <input id="3" type="date" name="fNacUsuario">
					    <script>document.getElementById('3').value='<%=dtSocio.getFechaNac().getTime()%>';</script>
					  </div>
